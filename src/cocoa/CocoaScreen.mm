...
#define TOCOCOAWINDOW Easy3DWindow * window=(Easy3DWindow *)(cocoaWindow);
#define RELOADCOCOAWINDOW  window=(Easy3DWindow *)(cocoaWindow);
...
///////////////////////////////////////////////////////////////////////////////
// WINDOW CLASS
@interface  Easy3DWindow : NSWindow
{
    @public
...
///////////////////////////////////////////////////////////////////////////////
// VIEW CLASS
@interface Easy3DView : NSView
// The default implementation doesn't pass rightMouseDown to responder chain
- (void)rightMouseDown:(NSEvent *)theEvent;
@end

@implementation Easy3DView
- (void)rightMouseDown:(NSEvent *)theEvent
{
...
void CocoaScreen::__openWindow(int w,int h,const char *title,bool fullscreen){
    ...
    //window
    NSWindow * window = [[Easy3DWindow alloc]
    ...
    //  Set view
	NSView *contentView = [[Easy3DView alloc] initWithFrame:frame];
